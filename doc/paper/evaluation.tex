...
Hardware performance was investigated on three 
...
We used the Link Quality Indicator readout provided by the CC2500 as a way to localize temperature readings. During averaging, the system calculates a number based on the LQI and the number of hops taken. The node's sensor reading is divided by that value before being summed into the average. An LQI of 0 was found to be 7-12 feet away and was given a factor of 3. A node within 1 foot of the sensor had a minimum LQI of 30 and was assigned a factor of 1. The factor decreases by 1 for every 15 point increase in LQI, and increases in the same manner.
...
Our measured power consumption lined up almost exactly with the calculated values except during power-down. However, this is the most critical area as 
